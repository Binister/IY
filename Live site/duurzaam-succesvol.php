   ...
   <div id="mo-wrapper">
      ...
      <section class="mo-content bg-lightblue p-t-m p-b-m">
         <div class="row">
            <div class="large-12 columns">
               <h4 class="whitetext m-b-sm">Stap 4: Duurzaam succesvol</h4>
               <p class="m-b-none">Je kunt jouw uitslagen direct gebruiken als startpunt voor een doelgericht ontwikkel-traject in de vorm van coaching, training, opleiding of blended learning.</p>
            </div>
         </div>
      </section>
      ...
      <section class="mo-content">
         <div class="row">
            <div class="large-6 columns">
               <h4>Coaching.</h4>
               <p>Als je één-op-één aan de slag wilt met jouw InsightYou profiel kunnen wij je koppelen aan een InsightYou certified professional coach. Wij zorgen ervoor dat je de gesprekspartner krijgt op het niveau dat bij je past, variërend van junior tot executive. [neem contact op]</p>
            </div>
      ...
      <section class="mo-content bg-full">
         <div class="row">
            ...
            <div class="large-6 columns">
               <h4>Training.</h4>
               <p>Voor groepen en teams is het mogelijk om trainingen te volgen om specifieke onderdelen van je biologische identiteit verder te ontwikkelen.</p>
            </div>
         </div>
      </section>
      ...
      <section class="mo-content">
         <div class="row">
            <div class="large-6 columns">
               <h4>Academy.</h4>
               <p>De mensen achter InsightYou hebben ervaring met het ontwikkelen en implementeren van volledige in-company academies.</p>
            </div>
            <div class="large-6 columns mo-animate text-center" data-animate="fadeInDown">
               ...
            </div>
      ...
      <section class="mo-content bg-full">
         <div class="row">
            ...
            <div class="large-6 columns">
               <h4>Maatwerk.</h4>
               <p>Voor ontwikkeltrajecten die niet in bovenstaande categoriseren vallen, help ik je graag met het ontwikkelen van een maatwerk programma toegespitst op de specifieke doelstellingen van jou als individu, team, of organisatie.</p>
            </div>
         </div>
      </section>
