 ...
 * ----------------------------------------------------------------------- */ 
   ...
   $('.sticky-menu').on('sticky-start', function() {
      ...
      if( (!$(this).hasClass('header2')) && (!$(this).hasClass('header3')) ) {
         $(".logo img").attr('src','img/logo.png').hide();
         $(".logo img").attr('src', function() {
            
            if(window.devicePixelRatio >= 2) {
               $(".logo img").attr('src','img/logo-alternative@2x.png');
            } else {
               $(".logo img").attr('src','img/logo-alternative.png');
            }            
      ...
      if($(this).hasClass('header3')) {
         $(".menu-content").insertAfter(".menu-move-sticky");

         if($(".search-content").is(":visible")){
            $(".search-content").hide();   
         } 

         if ($(".toggle-search-wrapper").is(":visible")) {
            $(".toggle-search-wrapper").hide();
         };
      }
   ...
   $('.sticky-menu').on('sticky-end', function() { 
      ...
      if( (!$(this).hasClass('header2')) && (!$(this).hasClass('header3')) ) {
         $(".logo img").attr('src','img/logo-alternative.png').hide();

         $(".logo img").attr('src', function() {
            
            if(window.devicePixelRatio >= 2) {
               $(".logo img").attr('src','img/logo@2x.png');
            } else {
      ...
      if($(this).hasClass('header3')) {
         $(".menu-content").appendTo(".menu-content-wrapper .columns");
