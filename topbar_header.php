                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        <div class="callus clearfix">
                            <ul>
                                <li><p><span>Email :</span> service@insightyou.com</p></li>
                                <li><p><span>Telefoon :</span> +31 (0)10 340 30 80</p></li>
                            </ul>
                        </div><!-- end callus -->
                    </div><!-- end col-lg-6 -->
                </div><!-- end row -->
						...
						<nav class="navbar navbar-default fhmm" role="navigation">
                            ...
                            <div id="defaultmenu" class="navbar-collapse collapse container">
                                <ul class="nav navbar-nav navbar-right">
                                    <!-- Mega Menu -->
                                    <li class="dropdown fhmm-fw"><a href="index.html" data-toggle="dropdown" class="dropdown-toggle">Home</a></li><!-- mega menu -->
                                    <li><a href="about.html">Product</a></li><!-- Mega Menu -->
                                    <li class="dropdown fhmm-fw"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Trusted</a></li><!-- mega menu -->
                                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Over Ons</a></li><!-- end standard drop down -->
